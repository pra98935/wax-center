			...
			<?php while ( have_posts() ) : the_post(); // Start the loop.?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<nav id="image-navigation" class="navigation image-navigation">
						<div class="nav-links">
							<div class="nav-previous"><?php previous_image_link( false, __( 'Previous Image', 'waxcenter' ) ); ?></div>
							<div class="nav-next"><?php next_image_link( false, __( 'Next Image', 'waxcenter' ) ); ?></div>
						</div><!-- .nav-links -->
					...
					<div class="entry-content">
						...
						<div class="entry-attachment">
							<?php
								/**
								 * Filter the default waxcenter image attachment size.
								 *
								 * @since wox Center 1.0
								 *
								 * @param string $image_size Image size. Default 'large'.
								 */
								$image_size = apply_filters( 'waxcenter_attachment_size', 'large' );
						...
						<?php
							...
							if ( $metadata ) {
								printf( '<span class="full-size-link"><span class="screen-reader-text">%1$s </span><a href="%2$s">%3$s &times; %4$s</a></span>',
									esc_html_x( 'Full size', 'Used before full size attachment link.', 'waxcenter' ),
